...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="./Hotel-Booking-Website-Assets/images/facilities/IMG_43553.svg" width="80px">
            ...
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white p-4"> 
                    <div class="profile d-flex align-items-center mb-3">
                        <img src="./Hotel-Booking-Website-Assets/images/facilities/IMG_43553.svg" width="30px">
                        <h6 class="m-0 ms-2">Random user1</h6>
                    </div>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere ratione animi est pariatur praesentium! Obcaecati accusantium doloremque molestiae debitis reiciendis perspiciatis iure officia. 
                        Exercitationem debitis sapiente eveniet quae doloremque neque?
                    </p>
                    <div class="rating">
                        <i class="bi bi-star-fill text-warning"></i>
                        <i class="bi bi-star-fill text-warning"></i>
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem optio deserunt explicabo expedita veritatis atque quaerat harum ratione, dolor placeat ex ut nostrum, eius sapiente odit incidunt, consectetur voluptates maiores.
                </p>
            </div>
            <div class="col-lg-4 p-4">
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0"> Designed and Developed by TJ </h6>
